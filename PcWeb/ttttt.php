...
<head>
    ...
    <!--===============================================================================================-->
    <link rel="stylesheet" href="css/left-layout.css">
    <link rel="stylesheet" href="css/top-layout.css">
    <link rel="stylesheet" href="css/menu.css">
    <link rel="stylesheet" href="css/center-layout.css">
    <link rel="stylesheet" href="css/divBottom.css">
    <link rel="stylesheet" href="css/LoginLayout.css">
    <link rel="stylesheet" href="css/LineDecorate.css">
    <!--===============================================================================================-->
<!--    <link rel="icon" type="image/png" href=""/>-->
    ...
    <link rel="stylesheet" type="text/css" href="Login_v16/Login_v16/css/copyMain.css">
    <!--===============================================================================================-->
...
<div id="header"
    ...
    <span style="position: absolute;top: 5px;right: 0;color: white;text-align: center;width: 130px;height: 65px">
            <?php if($key==0){?>
                <div>
                    <form action="Login_v16/Login_v16/SignOut.php">
...
<div id="DIV_BODY"
    ...
    <div id="CENTER" style="position: absolute">
        <div id="content" style="background-color: white">
            <!--  公告 列表區  -->
            <div id="MessageAnnouncement" class="Chose">
                <div id="index-news">
                    ...
                    <?php
                    $Information = mysqli_query($link, "SELECT * FROM `BulletinBoard`");
                            ...
                            <div class="index-news-list-info-box" style="display: none">
                                ...
                                <?php if($key==0){?>
                                    <div class="index-news-list-date-edit">
                                        <form action="Login_v16/Login_v16/DeleteData.php" method="get">
            ...
            <div id="PersonalInformation" class="Chose">
                <div id="index-news">
                    <div class="index-news-title-box">
                        <div class="index-news-icon">
                            <img src="image/JournalPapers.jpg">
                        </div>
                    </div>
                    <?php
                ...
                <div id="index-news">
                    <div class="index-news-title-box">
                        <div class="index-news-icon">
                            <img src="image/ConferencePapers.jpg">
                        </div>
                    </div>
                    <?php
                ...
                <div id="index-news">
                    <div class="index-news-title-box">
                        <div class="index-news-icon">
                            <img src="image/ResearchGrant.jpg">
                        </div>
                    </div>
                    <?php
            ...
            <div id="ComputerNetworks" class="Chose">
                ...
                <div id="index-news">
                    <div class="index-news-title-box">
                        <div class="index-news-icon">
                            <img src="image/course_slides.jpg">
                        </div>
                    </div>
        ...
        <div class="modal-content animate">
            <div style="height: 90%;position: relative;">
                ...
                <div id="InputContent" style="position: relative;">
                    <h1>Edit</h1>
                    <form action="Login_v16/Login_v16/UpData.php" method="GET" enctype="multipart/form-data" style="position: absolute;">
        ...
        <div class="modal-content animate">
            ...
            <span style="position: absolute;right: 2.5%;top: 30px" onclick="document.getElementById('Insert_BB').style.display='none'"
                ...
                <div id="InputContent" style="margin: 0 auto">
                    <form action="Login_v16/Login_v16/InsertData.php" method="GET" enctype="multipart/form-data" style="position: absolute;">
        ...
        <div class="modal-content animate">
            <div style="height: 90%;position: relative;">
                ...
                <div style="position: relative;">
                    ...
                    <form action="Login_v16/Login_v16/UpData.php" method="GET" style="position: absolute;">
    ...
    <div id="SignIn" class="limiter">
        <div class="container-login100" style="background: transparent">
            <div class="wrap-login100 p-t-30 p-b-50" style="width: 500px">
                ...
                <form class="login100-form validate-form p-b-33 p-t-5" action="Login_v16/Login_v16/LoginChack.php" method="post">
