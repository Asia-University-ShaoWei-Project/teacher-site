...
<div id="Edit" class="modal" style="z-index: 99">
    <form class="modal-content animate">
        <div style="height: 90%;position: relative;">
            <span style="position: absolute;right: 2.5%;top: 30px" onclick="document.getElementById('Edit').style.display='none'"
...
<!--                <input type="text" name="a1" value="123">-->
<!--                <br>-->
<!--                <input type="text" name="a2" value="456">-->
<!--                <br>-->
...
<?php
switch ($value) {
    case 0:{$InformationA = mysqli_query($link, "SELECT * FROM `BulletinBoard`");break;}
    case 1:
        {
