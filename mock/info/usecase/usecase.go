...
func NewUsecase() domain.InfoUsecase {
	return &Usecase{}
}
func (u *Usecase) Create(ctx context.Context, req *domain.CreateInfoBulletinRequest) (domain.CreateInfoBulletinResponse, error) {
	return domain.CreateInfoBulletinResponse{}, nil
}
