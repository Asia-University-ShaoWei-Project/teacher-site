...
func (i *InfoDbRepository) Get(ctx context.Context, req *domain.GetInfoBulletinRequest) ([]domain.InfoBulletinResponse, error) {
	return []domain.InfoBulletinResponse{}, nil
}
func (i *InfoDbRepository) GetLastModified(ctx context.Context, teacherDomain string) (string, error) {
